<template>
    <div class="popup-background" :class="{ 'show-popup': isPopupAddOpen }">
            ...
            <div class="popup-add-dialog">
                <div class="popup-add-dialog-content">
                    ...
                    <div class="popup-add-dialog-content-body">
                        ...
                        <button class="button-confirm" @click="addStudentParent()">Добавить</button>
                        <button class="button-deny button-deny-add" @click="closePopupAdd">Отмена</button>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="popup-background" :class="{ 'show-popup': isPopupEditOpen }">
            ...
            <div class="popup-edit-dialog">
                <div class="popup-edit-dialog-content">
                    ...
                    <div class="popup-edit-dialog-content-body">
                        ...
                        <button class="button-confirm" @click="editStudentParent()">Сохранить</button>
    ...
    <div class="popup-background" :class="{ 'show-popup': isPopupDeleteOpen }">
