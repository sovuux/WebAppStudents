            ...
            <table class="data-table">
                ...
                <tbody>
                    <tr v-for="student in students" :key="student.id">
                        ...
                        <td>
                            <button class="button-edit" @click="showPopupEdit = true; editStudent()">
                        ...
                        <td>
                            <button class="button-delete" @click="showPopupDelete = true">
            ...
            <div class="popup-delete-dialog">
                <div class="popup-delete-dialog-content">
                    <div class="popup-delete-dialog-content-header">
                        <h5 class="popup-delete-dialog-content-header-title" id="popup-delete-label">{{ popupDeleteTitle }}</h5>
                    </div>
                    <div class="popup-delete-dialog-content-body">
                        <button class="button-confirm" @click="deleteStudent(student.id)">Да</button>
    ...
    export default {
        ...
        methods: {
            ...
            saveChanges() {
                ...
                axios.put('${API_URL_EDIT}/${this.selectedStudent.id}', this.selectedStudent)
                .then((response) => {
            ...
            deleteStudent(studentId) {
                const API_URL_DELETE = "https://localhost:7167/api/Student/{Id}"
